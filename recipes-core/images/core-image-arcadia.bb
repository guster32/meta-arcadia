...
IMAGE_INSTALL:append:qemux86-64=" openssh openssh-sftp openssh-sftp-server packagegroup-core-buildessential ninja llvm vim git curl wget htop iftop libtool-native libtool"
